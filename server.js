...
`;
        fs.writeFileSync(interfaceConfigPath, interfaceContent.trim());
        ...
        if (hotspotDhcpServer.enabled) {
            // FIX: The 'dhcp-range' directive for dnsmasq should not include the netmask,
            // as dnsmasq infers it from the interface's configuration. Including it can
            // lead to configuration errors and service startup failure.
