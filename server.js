...
adminRouter.put('/network-config', adminAuth, (req, res) => {
    ...
    (async () => {
        try {
            ...
            // 4. FIX: Update splash.html redirect and nodogsplash config atomically
            ...
            try {
                ...
                const moveCommand = isProd ? `sudo mv ${tempSplashPath} ${SPLASH_HTML_PATH}` : `mv ${tempSplashPath} ${SPLASH_HTML_PATH}`;
