            ...
            {config ? (
                <form onSubmit={handleSave} className="space-y-6">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="space-y-6">
                            ...
                            {config.hotspotDhcpServer.enabled && (
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-6 border-l-2 border-indigo-100">
                                    <div>
                    ...
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-yellow-700">Applying changes will restart your hotspot interface and may briefly disconnect users. Incorrect settings can make your device inaccessible.</p>
                    </div>
                    ...
                    >
                        {isSaving ? 'Applying...' : 'Save & Apply Changes'}
                    </button>
                </form>
